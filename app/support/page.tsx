...
export default function SupportPage() {
  ...
  return (
    <div className="royal-surface royal-grid relative min-h-screen bg-[#12040c] text-white">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="royal-panel flex items-start gap-4 rounded-3xl border border-white/10 bg-[#14070f]/90 p-5 backdrop-blur-xl">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm font-semibold text-amber-300">support@subhlaxmi.com</p>
                </div>
              </div>
            </div>
