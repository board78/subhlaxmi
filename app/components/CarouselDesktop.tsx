...
export function CarouselDesktop({
  ...
  <div className="relative w-full overflow-hidden rounded-[22px] bg-black/20 border border-white/10 shadow-2xl">
    ...
    {/* Dots — image ke andar bottom center mein */}
        ...
        <button
          ...
          className={`
            ...
            ${i === activeIndex
              ...
              : "w-[6px] h-[6px] bg-white/40 hover:bg-white/60 hover:scale-110"
            }
          `}
        />
      ))}
